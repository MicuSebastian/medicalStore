...
<h3 style="color: black">*If there is no address it means that you did not set your address!</h3>
<h3 style="color: black">*This address will also be updated to your profile.</h3>
<hr style="width: 100%">
<div class="left-div">
...
<div class="right-div">
<h3>Pay online on this paypal@pay.com</h3>
...
<div class="left-div">
<h3>Mobile Number</h3>
<input class="input-style" type="text" name="mobileNumber" value="<%=rs2.getString(3) %>" placeholder="Enter Phone Number" required>
<h3 style="color: black">*This mobile number will also be updated to your profile.</h3>
</div>
<div class="right-div">
<h3 style="color: black">*If the transaction id is wrong then your order will be cancelled!</h3>
<button class="button" type="submit">Proceed to Generate & Save<i class='far fa-arrow-alt-circle-right'></i></button>
